...
<div class="container-laobuluo-main">
    <div class="laobuluo-wbs-header" style="margin-bottom: 15px;">
        <div class="laobuluo-wbs-logo"><a><img src="<?php echo plugin_dir_url(__FILE__); ?>layui/images/logo.png"></a><span class="wbs-span">老部落百度快速收录插件</span><span class="wbs-free">Free V1.1</span></div>
        <div class="laobuluo-wbs-btn">
            <a class="layui-btn layui-btn-primary" href="https://www.laobuluo.com/?utm_source=lbs-setting&utm_media=link&utm_campaign=header" target="_blank"><i class="layui-icon layui-icon-home"></i> 插件主页</a>
            <a class="layui-btn layui-btn-primary" href="https://www.laobuluo.com/4125.html?utm_source=lbs-setting&utm_media=link&utm_campaign=header" target="_blank"><i class="layui-icon layui-icon-release"></i> 插件教程</a>
        </div>
    </div>
</div>
<!-- 内容 -->
                ...
                <div class="laobuluo-panel">
                    <div class="laobuluo-controw">
                        ...
                        <form class="layui-form wpcosform" action="<?php echo wp_nonce_url('./admin.php?page=' . $this->base_folder . '/setting'); ?>" name="laobuluo_baidu_submit_form" method="post">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">收录查询</label>
                                <div class="layui-input-inline">
                                    <input <?php if($this->options['check_switch']) echo 'checked="TRUE"'; ?> type="checkbox" name="check_switch" title="启用" />
                                </div>
                            </div>
                            <div class="layui-form-item">
                                 <label class="layui-form-label"></label>
                                 <p class="layui-form-mid layui-word-aux">开启后自动检测文章是否被百度收录，在文章列表中看到。</p>
                            </div>
                            <div class="layui-form-item">
                                 <label class="layui-form-label">COOKIES</label>
                                 <div class="layui-input-inline" >
                                      <input class="layui-input" type="text" name="check_cookie" value="<?php echo esc_attr($this->options['check_cookie']); ?>" size="30"placeholder="[选填]"/>
                                 </div>
                                 
                            </div>
                             <div class="layui-form-item">
                                 <label class="layui-form-label"></label>
                                 <p class="layui-form-mid layui-word-aux">若需要百度安全验证，请试下设置登陆百度账号cookie, BAIDUID的值。（默认留空）</p>
                            </div>
                            <div class="layui-form-item">
                                 <label class="layui-form-label"></label>
                                 <div class="layui-input-block">
                ...
                <div id="nav">
                    <div class="laobuluo-panel">
                        ...
                        <div class="laobuluo-shangjia">
                            <a href="https://www.laobuluo.com/3475.html?utm_source=lbs-setting&utm_media=link&utm_campaign=rightsads" target="_blank">
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
                ...
                <div class="laobuluo-links">
                    <a href="https://www.laobuluo.com/?utm_source=lbs-setting&utm_media=link&utm_campaign=footer" target="_blank">插件官方</a>
                    <a href="https://www.laobuluo.com/donate/?utm_source=lbs-setting&utm_media=link&utm_campaign=footer" target="_blank">赞助插件</a>
                    <a href="https://www.laobuluo.com/4125.html?utm_source=lbs-setting&utm_media=link&utm_campaign=footer" target="_blank">使用说明</a>
                    <a href="https://www.laobuluo.com/about/?utm_source=lbs-setting&utm_media=link&utm_campaign=footer" target="_blank">关于我们</a>
                </div>
            </div>
        </div>
    </div>
