...
$('.waifu-tool .info-circle').click(function(){
    window.open('https://www.puresys.net/?page_id=24')
});
    ...
    if(window.location.href == SiteIndexUrl){
        ...
        if(document.referrer!==''){
            ...
            if(window.location.hostname==referrer.hostname){
                ...
                text = 'Hello! 来自 搜狗搜索 的朋友<br>欢迎阅读<span style="color:#0099cc;">『'+document.title.split(' - ')[0]+'』</span>'
            }else if(domain=='firpe') {
                text = 'Hello! 来自 FIRPE 的朋友<br>欢迎阅读<span style="color:#0099cc;">『'+document.title.split(' - ')[0]+'』</span>'
            }else if(domain=='yrxitong') {
                text = 'Hello! 来自 小鱼儿yr系统 的朋友<br>欢迎阅读<span style="color:#0099cc;">『'+document.title.split(' - ')[0]+'』</span>'
            }else{
