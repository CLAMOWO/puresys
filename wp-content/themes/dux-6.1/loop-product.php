    ...
    <div class="loop-product-container">
        ...
        <div class="loop-product-side">
            <div class="loop-product-filters">
                ...
                <h3><a class="loop-product-filters-all" href="<?php echo get_category_link($root) ?>">全部</a><span class="loop-product-filters-more"><i class="fa fa-chevron-down"></i></span><i class="fa fa-folder"></i><?php echo $root->cat_name ?></h3>
                <ul>
                    <?php 
            ...
            <?php } ?>
            <?php _the_ads($name='ads_pcat_01', $class='asb-pcat asb-pcat-01') ?>
        </div>
